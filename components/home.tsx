    ...
    return (
        <div className="flex flex-col w-full h-full md:flex-row items-center justify-center overflow-auto justify-between gap-x-4">
            ...
            <div className="z-10 md:h-full mt-8 md:mt-0 md:p-8">
                ...
                <Image src="/pic.jpg" alt="" width="200" height="300" className="w-[200px] h-[200px] object-scale-down md:object-cover md:min-w-[300px] md:w-[900px] md:h-full ml-8 md:rounded-3xl rounded-full border-4 border-[#292929] md:border-none bg-black" />
            </div>
            <div className="my-[40px] w-full min-w-[300px]  text-[25px] md:text-[42px] font-semibold flex flex-col items-center dark:text-white text-[#666666]">
